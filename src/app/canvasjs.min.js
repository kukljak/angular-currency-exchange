...
(function () {
  ...
  function Va(g, m, v) {
    "millisecond" === v ? g.setMilliseconds(g.getMilliseconds() + 1 * m) : "second" === v ? g.setSeconds(g.getSeconds() + 1 * m) : "minute" === v ? g.setMinutes(g.getMinutes() + 1 * m) : "hour" === v ? g.setHours(g.getHours() + 1 * m) : "day" === v ? g.setDate(g.getDate() + 1 * m) : "week" === v ? g.setDate(g.getDate() + 7 * m) : "month" === v ? g.setMonth(g.getMonth() + 1 * m) : "year" === v && g.setFullYear(g.getFullYear() +
      1 * m);
    return g
  }
    ...
    if (isNaN(w)) {
      try {
        g = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" +
          g + "; font-size:" + m + "px; font-weight:" + v + ";";
        if (!wa) {
  ...
  function J(g, m, v, w, qa) {
    ...
    w.push([g, m, v, qa]);
    return g.addEventListener ? (g.addEventListener(m, v, qa), v) : g.attachEvent ? (w = function (m) {
      m = m || window.event;
  ...
  function gb(g) {
    ...
    if (g.exportEnabled && g._dropdownMenu) {
      ...
      g.toolbar.itemBackgroundColor + ";box-shadow: 2px 2px 10px " + v, g._dropdownMenu.style.display = "none", g._toolBar.appendChild(g._dropdownMenu), J(g._dropdownMenu, "blur", function () {
        ...
        m || (this.style.backgroundColor = g.toolbar.itemBackgroundColorOnHover, this.style.color = g.toolbar.fontColorOnHover)
      }, g.allDOMEventHandlers, !0), J(v, "mouseout", function () {
        m || (this.style.backgroundColor = g.toolbar.itemBackgroundColor, this.style.color = g.toolbar.fontColor)
  ...
  function La(g, m, v) {
    if (w && Za) {
      ...
      g.width = m * ka;
      g.height = v * ka;
      Qa !== Ma && (g.style.width = m + "px", g.style.height = v + "px", s.scale(ka, ka))
  ...
  function hb(g) {
    if (!ib) {
      ...
      "undefined" === typeof pa.Chart.creditHref ?
        (g.creditHref = W("iuuqr;..b`ow`rkr/bnl."), g.creditText = W("B`ow`rKR/bnl")) : (m = g.updateOption("creditText"), v = g.updateOption("creditHref"));
      if (g.creditHref && g.creditText) {
        ...
        if (0 === g.renderCount || m || v) g._creditLink.setAttribute("href", g.creditHref), g._creditLink.innerHTML = g.creditText;
  ...
  function va(g, m, v) {
    m.getAttribute("state") || (m.style.backgroundColor = g.toolbar.itemBackgroundColor, m.style.color = g.toolbar.fontColor, m.style.border = "none", ga(m, {
    ...
    m.getAttribute("state") !==
      v && (m.setAttribute("state", v), m.setAttribute("type", "button"), ga(m, {
        padding: "5px 12px",
        cursor: "pointer",
        "float": "left",
        width: "40px",
        ...
        lineHeight: "0"
      }), m.setAttribute("title", g._cultureInfo[v + "Text"]), m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + jb[v].image + "' alt='" + g._cultureInfo[v + "Text"] + "' />")
  }

  function Ka() {
    for (var g = null, m = 0; m < arguments.length; m++) g = arguments[m], g.style && (g.style.display = "inline")
  }

  function ua() {
    for (var g =
        null, m = 0; m < arguments.length; m++)(g = arguments[m]) && g.style && (g.style.display = "none")
  }

  function Ra(g, m, v, s, w) {
    if (null === g || "undefined" === typeof g) return "undefined" === typeof v ? m : v;
    g = parseFloat(g.toString()) * (0 <= g.toString().indexOf("%") ? m / 100 : 1);
  ...
  function U(g, m, v, w, qa) {
    ...
    g = {};
    this.theme && s(this.parent) && s(m) && s(w) ? g = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === w ? g = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (w = Math.min(this.parent.themeOptions[m].length - 1, w), g = this.parent.themeOptions[m][w]));
    this.themeOptions = g;
    this.options = v ? v : {
      _isPlaceholder: !0
    };
  ...
  (function () {
    S.fSDec = function (g) {
      for (var m = "", v = 0; v < g.length; v++) m += String.fromCharCode(Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(v));
      return m
    };
    ...
    S._fTWm = function (g) {
      if ("undefined" === typeof S.pro.sCH && !bb) try {
        ...
        v = "cm" === S.pos[m] || "um" === S.pos[m] ? 0 : g.width - w[S.fSDec("ld`rtsdUdyu")](S.fSDec("B`ow`rKR!Ush`m")).width;
        s = "um" === S.pos[m] ? 0 : g.height - 11;
        w[S.fSDec("ghmmUdyu")](S.fSDec("B`ow`rKR!Ush`m"), v, s);
        "cs" === S.pos[m] && (g[S.fSDec("^bsdehuMhoj")].style.right = S.fSDec("`tun"))
      } catch (y) {}
    }
  })();
  var fb = function () {
    ...
    lb = function (g, m, v) {
      ...
      return Math.max("theme4" === this.theme ? 0 : 300 <= m ? 12 : 11, Math.round(m * (g / 400)))
    },
    Aa = function () {
    ...
    ea = function (g, m, v) {
      ...
      for (var K = 0; F && K < F.length; K++)
        ...
        } S && (m = Math.floor(g), F = -Math.floor(Math.log(g) / Math.LN10 + 1), U = 0 === g ? 0 : 0 === m ? -(P + F) : String(m).length - P, E /= Math.pow(10, U));
      0 > N && (N = K);
      E = (g * E).toFixed(J);
      m = E.split(".");
      E = (m[0] + "").split("");
      ...
      for (S = F = K = J = N = 0; 0 < M.length;)
        if (m = M.pop(), "#" === m || "0" ===
          ...
          } else 0 < E.length ? (v = E.pop() + v, J++, S++) : "0" === m && (v = "0" + v, J++, S++), 0 === S % F && (K === R && 0 < E.length) && (v = y + v);
      else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (K++, F = S, S = 0, 0 < E.length && (v = y + v)) : v = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + v : m + v : (m = 0 > U ? m.replace("+",
        "").replace("-", "") : m.replace("-", ""), v += m.replace(/[0]+/, function (a) {
        return X(U, a.length)
      }));
      y = "";
      for (M = !1; 0 < H.length;) m = H.shift(), "#" === m || "0" === m ? 0 < g.length && 0 !== Number(g.join("")) ? (y += g.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > U ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function (a) {
        return X(U,
          a.length)
      }));
      v += (M ? w : "") + y;
    ...
    Na = function (g) {
      var m = 0,
        v = 0;
      g = g || window.event;
      g.offsetX || 0 === g.offsetX ? (m = g.offsetX, v = g.offsetY) : g.layerX || 0 == g.layerX ? (m = g.layerX, v = g.layerY) : (m = g.pageX - g.target.offsetLeft, v = g.pageY - g.target.offsetTop);
      return {
        x: m,
        y: v
      }
    ...
    ca = function (g, m, v, s, w, y, E, F, N, M, P, S, H) {
      ...
      g.globalAlpha = 1;
      0 < E && (H = 0 === E % 2 ? 0 : 0.5, g.beginPath(), g.lineWidth = E, g.strokeStyle = F, g.moveTo(m, v), g.rect(m - H, v - H, s - m + 2 * H, w - v + 2 * H), g.stroke());
      g.restore();
      !0 === N && (g.save(), g.beginPath(), g.moveTo(m, v), g.lineTo(m + J, v + J), g.lineTo(s - J, v + J), g.lineTo(s, v), g.closePath(), E = g.createLinearGradient((s + m) / 2, v + J, (s + m) / 2, v), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, .4)"), g.fillStyle = E, g.fill(), g.restore());
      !0 === M && (g.save(), g.beginPath(), g.moveTo(m, w), g.lineTo(m +
        J, w - J), g.lineTo(s - J, w - J), g.lineTo(s, w), g.closePath(), E = g.createLinearGradient((s + m) / 2, w - J, (s + m) / 2, w), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, .4)"), g.fillStyle = E, g.fill(), g.restore());
      !0 === P && (g.save(), g.beginPath(), g.moveTo(m, v), g.lineTo(m + J, v + J), g.lineTo(m + J, w - J), g.lineTo(m, w), g.closePath(), E = g.createLinearGradient(m + J, (w + v) / 2, m, (w + v) / 2), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), g.fillStyle = E, g.fill(), g.restore());
    ...
    W = function (g) {
      for (var m = "", s = 0; s < g.length; s++) m += String.fromCharCode(Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(s));
      return m
    },
  ...
  U.prototype.setOptions = function (g, m) {
    if (pa[this._defaultsKey]) {
      var s = pa[this._defaultsKey],
        w;
      for (w in s) "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = g && w in g ? g[w] : m && w in m ? m[w] : s[w])
  ...
  U.prototype.get = function (g) {
    ...
    if (m.hasOwnProperty(g) || m.publicProperties && m.publicProperties.hasOwnProperty(g)) return this[g];
    window.console &&
  ...
  U.prototype.set = function (g, m, s) {
    ...
    else if (w.hasOwnProperty(g) || w.publicProperties && w.publicProperties.hasOwnProperty(g) && "readWrite" === w.publicProperties[g]) this.options._isPlaceholder && this.createUserOptions(), this.options[g] = m;
    else {
  ...
  U.prototype.createUserOptions = function (g) {
    if ("undefined" !== typeof g || this.options._isPlaceholder)
      if (this.parent.options._isPlaceholder &&
        ...
        m[s] = this.options
      } else this.options = "undefined" === typeof g ? {} : g, g = this.parent.options, this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (s = m.charAt(0).toLowerCase(), 1 < m.length && (s = s.concat(m.slice(1))),
        m = s) : m = void 0, g[m] = this.options
  };
  ...
  U.prototype.updateOption = function (g) {
    ...
    this.themeOptions = w;
    g in m && (y = g in this.options ? this.options[g] : w && g in w ? w[g] : m[g]);
  ...
  Da.prototype.registerSpace = function (g, m) {
    "top" === g ? this._topOccupied += m.height : "bottom" === g ? this._bottomOccupied += m.height : "left" === g ? this._leftOccupied += m.width : "right" === g && (this._rightOccupied += m.width)
  };
  ...
  ia.prototype._getLineWithWidth = function (g, m, s) {
    ...
    s > m && 1 < E.length && (E = E.substr(0, E.length - 1), s = this.ctx.measureText(E).width);
    m = !0;
    if (E.length === g.length || " " === g[E.length]) m = !1;
    m && (g = E.split(" "), 1 < g.length && g.pop(), E = g.join(" "), s = this.ctx.measureText(E).width);
    return {
      text: E,
      width: s
    }
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      M = J.measureText();
      "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (y = m.y1 + 2, H = "top") : "bottom" === this.verticalAlign && (y = m.y2 - 2 - M.height, H = "bottom"), "left" === this.horizontalAlign ? w = m.x1 + 2 : "center" === this.horizontalAlign ? w = m.x1 + m.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (w = m.x2 - 2 - M.width - E), N = this.horizontalAlign,
  ...
  Ta.prototype.get = function (g, m) {
    var w =
      null;
    0 < this.pool.length ? (w = this.pool.pop(), La(w, g, m)) : w = ta(g, m);
    return w
  };
  ...
  y = Oa.Chart = function () {
    ...
    function y(a, d, c, b, e, f, p, t, B, k) {
      ...
      l = 0 < p.trimLength ? Math.abs(l * p.trimLength / 100) : Math.abs(l - p.length);
      ...
      a.beginPath();
      B && 0 < p.thickness ? (a.moveTo(b - l, c), a.lineTo(b - l, e), a.moveTo(d + l, c), a.lineTo(d + l, e)) : 0 < p.thickness && (a.moveTo(d, c + l), a.lineTo(b, c + l), a.moveTo(d, e - l), a.lineTo(b, e - l));
      a.stroke();
      a.restore()
    }
          ...
          if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
            if (this.options.axisY && 0 < this.options.axisY.length) {
              if (!this.axisY.length)
                for (var c = 0; c < this.options.axisY.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY",
                  "bottom"));
          ...
          if ("secondary" === this.data[d].axisYType)
            if (this.options.axisY2 && 0 < this.options.axisY2.length) {
              if (!this.axisY2.length)
                for (c = 0; c < this.options.axisY2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new E(this,
          ...
          if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
            if (this.options.axisX && 0 < this.options.axisX.length) {
              if (!this.axisX.length)
                for (c = 0; c < this.options.axisX.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement &&
                  this._axes.push(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "left"));
          ...
          if ("secondary" === this.data[d].axisXType)
            if (this.options.axisX2 && 0 < this.options.axisX2.length) {
              if (!this.axisX2.length)
                for (c = 0; c < this.options.axisX2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" ===
                  this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "right"));
    ...
    m.prototype.renderElements = function () {
      ...
      var l = this;
      if (0 < c.length) l.disableToolTip = !0, l._animator.animate(200,
        l.animationDuration,
        function (a) {
          l.ctx.clearRect(0, 0, l.width, l.height);
          l.ctx.drawImage(b, 0, 0, Math.floor(l.width * ka), Math.floor(l.height * ka), 0, 0, l.width, l.height);
        ...
        function () {
          ...
          for (var a = 0; a < l.plotInfo.plotTypes.length; a++)
            for (var e =
                l.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) e.plotUnits[d].targetCanvas = null;
          b = null;
          l.disableToolTip = !1;
        ...
        if (l._breaksCanvas)
          if (w) l.plotArea.ctx.drawImage(l._breaksCanvas, 0, 0, this.width, this.height);
          else
      ...
      this.renderCount++;
      Ga && (l = this, setTimeout(function () {
        var a = document.getElementById("ghostCanvasCopy");
        a && (La(a, l.width, l.height), a.getContext("2d").drawImage(l._eventManager.ghostCanvas, 0, 0))
      }, 2E3));
      ...
      for (var a = "", d = 0; d < this.data.length; d++)
        if (a =
          ...
          for (p = 0; p < c.plotUnits.length; p++)
            if (c.plotUnits[p].axisYType === a.axisYType && c.plotUnits[p].axisXType === a.axisXType && c.plotUnits[p].axisYIndex === a.axisYIndex &&
        ...
        for (c = this.plotInfo.plotTypes[d], p = a = 0; p < c.plotUnits.length; p++) c.plotUnits[p].previousDataSeriesCount = a, a += c.plotUnits[p].dataSeriesIndexes.length
    };
        ...
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          for (B = 0; B < t.dataPoints.length; B++) {
            ...
            if (0 < B) {
              ...
              } else r = b - t.dataPoints[B - 1].x, 0 > r &&
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], t = [], B = Infinity, k = -Infinity, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if ("normal" === n.axisPlacement ||
            "xySwapped" === n.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
        ...
        for (q in t) t.hasOwnProperty(q) && !isNaN(q) && (a = t[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin =
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, t = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
          var l = this.data[a.dataSeriesIndexes[k]],
            ...
            h = !1,
            r;
          if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement) var g = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
          ...
          if (l.dataPoints[n].x && l.dataPoints[n].x.getTime || "dateTime" === l.xValueType) f = !0;
          for (n =
            0; n < l.dataPoints.length; n++) {
            "undefined" === typeof l.dataPoints[n].x && (l.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0));
            l.dataPoints[n].x.getTime ? (f = !0, b = l.dataPoints[n].x.getTime()) : b = l.dataPoints[n].x;
            ...
            if (0 < n) {
              ...
              } else u = b - l.dataPoints[n - 1].x, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u);
              s(e) || null === l.dataPoints[n - 1].y ||
                (a.axisY.logarithmic ? 0 < e && (u = e / l.dataPoints[n - 1].y, 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - l.dataPoints[n - 1].y, 0 > u && (u *= -1), d.minDiff > u && 0 !== u && (d.minDiff = u)))
            }
            if (b < g && !q) null !== e && (r = b);
            else {
              if (!q && (q = !0, 0 < n)) {
    ...
    m.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (k.dataPoints[l].x && k.dataPoints[l].x.getTime || "dateTime" === k.xValueType) t = !0;
          for (l = 0; l < k.dataPoints.length; l++) {
            "undefined" === typeof k.dataPoints[l].x && (k.dataPoints[l].x = l + (a.axisX.logarithmic ? 1 : 0));
            k.dataPoints[l].x.getTime ? (t = !0, b = k.dataPoints[l].x.getTime()) : b = k.dataPoints[l].x;
            ...
            f < d.min && (d.min = f);
            p > d.max && (d.max = p);
            0 < l && (a.axisX.logarithmic ? (r = b / k.dataPoints[l - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[l - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), e && (null !== e[0] && k.dataPoints[l - 1].y && null !== k.dataPoints[l - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / k.dataPoints[l - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[l - 1].y[0],
              ...
              if (c.viewPortMin === b && e)
                for (x = 0; x < e.length; x++)
                  if (null === e[x] && h < b) {
                    c.viewPortMin = h;
                    break
                  } null === e ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (f < d.viewPortMin && (d.viewPortMin = f), p > d.viewPortMax && (d.viewPortMax = p))
            }
          }
          k.axisX.valueType =
        ...
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          for (B = 0; B < t.dataPoints.length; B++) "undefined" !==
            typeof t.dataPoints[B].isCumulativeSum && !0 === t.dataPoints[B].isCumulativeSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = 0, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[B].isIntermediateSum && !0 === t.dataPoints[B].isIntermediateSum ? (t.dataPointEOs[B].cumulativeSumYStartValue = n, t.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPoints[B].y = 0 === B ? 0 : b,
              n = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, b = 0) : (e = "number" !== typeof t.dataPoints[B].y ? 0 : t.dataPoints[B].y, t.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum, t.dataPointEOs[B].cumulativeSum = 0 === B ? e : t.dataPointEOs[B - 1].cumulativeSum + e, b += e);
          for (B = 0; B < t.dataPoints.length; B++)
            if ("undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[B].x.getTime ? (f = !0, b = t.dataPoints[B].x.getTime()) : b = t.dataPoints[B].x, e = t.dataPoints[B].y,
    ...
    m.prototype.calculateAutoBreaks = function () {
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c)
            for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, k = f.min, p = f.max, l = d.min, n = d.max, f = f._dataRanges,
                ...
                for (t = 0; t < g.dataPoints.length; t++)
                  if (b && (q = (p + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = g.dataPoints[t].x.getTime ? g.dataPoints[t].x.getTime() : g.dataPoints[t].x, q = Math.floor((h - k) / q), h < f[q].min && (f[q].min = h), h > f[q].max && (f[q].max = h)), c) {
                    ...
                    if ((h = "waterfall" ===
                      ...
                      for (var w = 0; w < h.length; w++) q = Math.floor((h[w] - l) / m), h[w] < d[q].min && (d[q].min = h[w]), h[w] > d[q].max && (d[q].max = h[w]);
                    else s(h) || (q = Math.floor((h - l) / m), h < d[q].min && (d[q].min = h), h > d[q].max && (d[q].max = h))
                  }
            }
        }
      }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
          for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges,
            ...
            if (!(4 > l.dataPoints.length))
              for (k = 0; k < l.dataPoints.length; k++) h = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = l.dataPoints[k].x.getTime ? l.dataPoints[k].x.getTime() : l.dataPoints[k].x, h = Math.floor((b - c) / h), b < f[h].min && (f[h].min = b), b > f[h].max && (f[h].max = b)
          }
      }
      for (var b, e = this, f = !1, p = 0; p < this._axes.length; p++)
        ...
        for (p = 0; p < this.plotInfo.plotTypes.length; p++)
          for (f = this.plotInfo.plotTypes[p], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" ===
        ...
        for (p = 0; p < this._axes.length; p++)
          if (this._axes[p].dataInfo._dataRanges) {
            ...
            if (this._axes[p].dataInfo.dataPointYNegativeSums) {
              ...
              l = k;
              for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (n = -1 * q[t], s(n) || (h = Math.floor((n - B) / b), n < l[h].min &&
                (l[h].min = n), n > l[h].max && (l[h].max = n)));
            ...
            if (this._axes[p].scaleBreaks.customBreaks)
              for (t = 0; t < this._axes[p].scaleBreaks.customBreaks.length; t++)
                for (b = 0; b < f.length; b++)
                  if (this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue ||
                    this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue || f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].startValue && this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].end || f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue && this._axes[p].scaleBreaks.customBreaks[t].endValue <= f[b].end) f.splice(b, 1), b--;
            f.sort(function (a, b) {
              return b.diff - a.diff
            });
            for (t = 0; t < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); t++) b =
    ...
    m.prototype._plotAreaMouseUp = function (a, d) {
      if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) &&
        ...
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled)
            for (e = f = 0; e < this._axes.length; e++) c = this._axes[e], c.logarithmic ? c.viewportMinimum < c.minimum ? (f = c.minimum / c.viewportMinimum, c.sessionVariables.newViewportMinimum = c.viewportMinimum * f, c.sessionVariables.newViewportMaximum =
              ...
              f, c.sessionVariables.newViewportMaximum = c.viewportMaximum - f, p = !0);
    ...
    m.prototype._plotAreaMouseMove = function (a, d) {
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled ||
            this.zoomEnabled)) {
          this.toolTip.hide();
        ...
        if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
          if (this.panEnabled) e = {
            ...
            return function () {
              p._zoomPanToSelectedRegion(b, c, e, f, !0) && (p._dispatchRangeEvent("rangeChanging",
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (var f = 0 <= this.zoomType.indexOf("x"),
          p = 0 <= this.zoomType.indexOf("y"), t = !1, B = [], k = [], l = [], n = 0; n < this._axes.length; n++)("axisX" === this._axes[n].type && f || "axisY" === this._axes[n].type && p) && k.push(this._axes[n]);
      for (p = 0; p < k.length; p++) {
        ...
        if (isFinite(n.dataInfo.minDiff))
          if (r =
            n.getApparentDifference(q, h, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && r < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && r < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || h > n.maximum)) B.push(n), l.push({
            val1: q,
            val2: h
          }), t = !0;
          else if (!e) {
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var l = this._indexLabels[a],
          ...
          q, h, p = la("indexLabelFontColor", l.dataPoint, l.dataSeries),
          ...
          k = la("indexLabelFontWeight", l.dataPoint,
            l.dataSeries),
        ...
        var m = la("indexLabelLineDashType", l.dataPoint, l.dataSeries),
          ...
          x = s(l.dataPoint.indexLabelLineThickness) ? s(l.dataSeries.options.indexLabelLineThickness) ? 0 : l.dataSeries.options.indexLabelLineThickness : l.dataPoint.indexLabelLineThickness,
          ...
          C = null;
        if (0 <= l.dataSeries.type.indexOf("stacked") || "pie" === l.dataSeries.type || "doughnut" === l.dataSeries.type) A = this.getPercentAndTotal(l.dataSeries, l.dataPoint);
        if (l.dataSeries.indexLabelFormatter || l.dataPoint.indexLabelFormatter) C = {
          chart: this,
        ...
        var D = l.dataPoint.indexLabelFormatter ? l.dataPoint.indexLabelFormatter(C) : l.dataPoint.indexLabel ?
          this.replaceKeywordsWithValue(l.dataPoint.indexLabel, l.dataPoint, l.dataSeries, null, l.indexKeyword) : l.dataSeries.indexLabelFormatter ? l.dataSeries.indexLabelFormatter(C) : l.dataSeries.indexLabel ? this.replaceKeywordsWithValue(l.dataSeries.indexLabel, l.dataPoint, l.dataSeries, null, l.indexKeyword) : null;
        if (null !== D && "" !== D) {
          ...
          if ("stackedarea100" === n) {
            ...
            if (l.dataPoint.x < e.viewportMinimum ||
              l.dataPoint.x > e.viewportMaximum || Math.max.apply(null, l.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, l.dataPoint.y) > f.viewportMaximum) continue
          } else if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
            if (l.dataPoint.x < e.viewportMinimum || l.dataPoint.x > e.viewportMaximum || l.dataPoint.y < f.viewportMinimum || l.dataPoint.y > f.viewportMaximum) continue
          } else if (0 <= n.indexOf("column") || "waterfall" === n || "error" === n && !l.axisSwapped) {
            if (l.dataPoint.x < e.viewportMinimum ||
              l.dataPoint.x > e.viewportMaximum || l.bounds.y1 > c.y2 || l.bounds.y2 < c.y1) continue
          } else if (0 <= n.indexOf("bar") || "error" === n) {
            if (l.dataPoint.x < e.viewportMinimum || l.dataPoint.x > e.viewportMaximum || l.bounds.x1 > c.x2 || l.bounds.x2 < c.x1) continue
          } else if ("candlestick" === n || "ohlc" === n) {
            if (l.dataPoint.x < e.viewportMinimum || l.dataPoint.x > e.viewportMaximum || Math.max.apply(null, l.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, l.dataPoint.y) > f.viewportMaximum) continue
          } else if (l.dataPoint.x < e.viewportMinimum || l.dataPoint.x >
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== A ? (e = c.y1, f = c.y2, 0 < v ? (h = l.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b, h < e && (h = "auto" === A ? Math.max(l.point.y, e) + r / 2 + t : e + r / 2 + t, y = h + k > l.point.y)) : (h = l.point.y +
              ...
              n) && (h = Math.min(l.point.y + t, c.y2 - k - t))), h = Math.min(h, f))
          } else 0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (A = "auto", p = 4) : 0 <= n.indexOf("stacked") ? "auto" === A && (A = "inside") : "bubble" === n && (A = "inside"), h = l.point.y + r / 2 - k / 2 + t, "inside" !== A ? (e = c.x1, f = c.x2, 0 > v ? (q = l.point.x - ("horizontal" === C ? B : B - r / 2) - p - b, q < e && (q = "auto" === A ? Math.max(l.point.x, e) + p : e + p, y = q + B > l.point.x)) : (q = l.point.x + ("horizontal" === C ? 0 : r / 2) + p + b, q > f - B - p - b && (q = "auto" === A ? Math.min(l.point.x, f) - ("horizontal" === C ? B : B / 2) - p : f -
          ...
          g.y = h;
          g.render(!0);
          x && ("inside" !== A && (0 > n.indexOf("bar") && ("error" !== n || !l.axisSwapped) &&
            ...
            (h - k < l.point.y ? 0 : -k) + t : (h - r / 2 < l.point.y ? k : 0) - r / 2)) : d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), h + ("vertical" === C ? h - k < l.point.y ? 0 : -k : (h - r / 2 < l.point.y ? k : 0) - r / 2)), d.stroke())
        }
      }
      d = {
        source: d,
      ...
      for (a = 0; a < this._indexLabels.length; a++) l = this._indexLabels[a], g = la("indexLabelBackgroundColor", l.dataPoint, l.dataSeries), l.dataSeries.indexLabelBackgroundColor = s(g) ? w ? "transparent" : null : g;
      return d
    };
        ...
        for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length) {
            for (var C = !1, u = 0; u < l.length; u++)
              if (x = l[u].x.getTime ? l[u].x.getTime() : l[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                  !C)))
                if ("number" !== typeof l[u].y) 0 < u && !(k.connectNullData || C || m) && (c.stroke(), w && b.stroke()), C = !0;
                else {
                  ...
                  m || C ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), n = k.nullDataLineDashType,
                    c.setLineDash(q)), c.lineTo(x, s), w && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), w && (b.beginPath(), b.moveTo(x, s))), C = m = !1) : (c.lineTo(x, s), w && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), w && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                  p = {
                    x: x,
                    y: s
                  };
                  u < l.length - 1 && (g !== (l[u].lineColor || r) || n !== (l[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), g = l[u].lineColor || r, c.strokeStyle = g, c.setLineDash && (l[u].lineDashType ? (n = l[u].lineDashType, c.setLineDash(N(n, k.lineThickness))) :
                  ...
                  }(l[u].indexLabel || k.indexLabel || l[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                    chartType: "line",
                    dataPoint: l[u],
                    dataSeries: k,
                    point: {
    ...
    m.prototype.renderStepLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], p, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length) {
            for (var C = !1, u = 0; u < l.length; u++)
              if (x = l[u].getTime ? l[u].x.getTime() : l[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                  (!k.connectNullData || !C)))
                if ("number" !== typeof l[u].y) 0 < u && !(k.connectNullData || C || m) && (c.stroke(), w && b.stroke()), C = !0;
                else {
                  var D = s;
                  ...
                  m || C ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x,
                    p.y), n = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, D), c.lineTo(x, s), w && (b.lineTo(x, D), b.lineTo(x, s))) : (c.beginPath(), c.moveTo(x, s), w && (b.beginPath(), b.moveTo(x, s))), C = m = !1) : (c.lineTo(x, D), w && b.lineTo(x, D), c.lineTo(x, s), w && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), w && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                  p = {
                    x: x,
                    y: s
                  };
                  u < l.length - 1 && (g !== (l[u].lineColor || r) || n !== (l[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), g = l[u].lineColor || r, c.strokeStyle =
                    g, c.setLineDash && (l[u].lineDashType ? (n = l[u].lineDashType, c.setLineDash(N(n, k.lineThickness))) : (n = k.lineDashType, c.setLineDash(h))));
                  if (0 < l[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, x, s, c), f.push(D), z = P(z), w && f.push({
                    x: x,
                    y: s,
                    ctx: b,
                    type: D.type,
        ...
        for (var p = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length)
            for (x = !1, m = 0; m < l.length; m++)
              if (u = l[m].getTime ? l[m].x.getTime() : l[m].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                if ("number" !== typeof l[m].y) 0 < m && !x && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !l[m - 1].lineDashType)) && (s[s.length -
                  ...
                  m < l.length - 1 && (g !== (l[m].lineColor || r) || n !== (l[m].lineDashType || k.lineDashType)) && (g = l[m].lineColor || r, s[s.length - 1].newStrokeStyle = g, b.setLineDash && (l[m].lineDashType ? (n = l[m].lineDashType, s[s.length - 1].newLineDashArray =
                  ...
                  }(l[m].indexLabel || k.indexLabel || l[m].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                    chartType: "spline",
                    dataPoint: l[m],
                    dataSeries: k,
                    point: {
    ...
    m.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        !this.dataPointMaxWidth && (this.dataPointMinWidth &&
          l < f) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
        n < f && (n = f);
        n > l && (n = l);
        c.save();
          ...
          if (0 < r.length)
            for (var g = 5 < n && h.bevelEnabled ? !0 : !1, f =
              ...
              if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                ...
                p = a.axisX.reversed ? p + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + l) * n << 0 : p - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + l) * n << 0;
                var m = a.axisX.reversed ? p - n << 0 : p + n << 0,
                  u;
                0 <= r[f].y ? u = k : (u = t, t = k);
                t > u && (b = t, t = u, u = b);
                b = r[f].color ? r[f].color : h._colorSet[f % h._colorSet.length];
                ca(c, p, t, m, u, b, 0, null, g && 0 <= r[f].y, 0 > r[f].y && g, !1, !1, h.fillOpacity);
                b = h.dataPointIds[f];
                ...
                b = P(b);
                w && ca(this._eventManager.ghostCtx, p, t, m, u, b, 0, null, !1, !1, !1, !1);
    ...
    m.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
          ...
          B = [],
          k = 0,
          l, n, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
          k =
          this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
        l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0;
        ...
        this.dataPointMaxWidth &&
          k > l && (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l));
        !this.dataPointMaxWidth && (this.dataPointMinWidth && l < k) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
        h < k && (h = k);
        h > l && (h = l);
        c.save();
        w && this._eventManager.ghostCtx.save();
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                ...
                var s = l - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                  C = s + h << 0,
                  D;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] :
                  0), 0 < t[b] && (n = a.axisY.convertValueToPixel(t[b]), D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = n);
                  ...
                  D = q - z;
                  f[b] = z + (D - n)
                } else z = p[b] ? p[b] : 0, D = n + z, n = q + z, p[b] = z + (D - n);
                b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
                ca(c, s, n, C, D, b, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, m.fillOpacity);
                b = m.dataPointIds[k];
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          var g =
            ...
            u = m.dataPoints;
          if (0 < u.length)
            for (var x = 5 < h && m.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
              if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                l = a.axisX.convertValueToPixel(b);
                ...
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  ...
                  typeof p[b] ? p[b] : 0, D = n + z, n = q + z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), p[b] = z + (D - n);
                b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
                ca(c, s, n, C, D, b, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, m.fillOpacity);
                b = m.dataPointIds[k];
                this._eventManager.objectMap[b] = {
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if (r[f].getTime ? B = r[f].x.getTime() : B = r[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                ...
                b =
                  P(b);
                w && ca(this._eventManager.ghostCtx, u, t, p, m, b, 0, null, !1, !1, !1, !1);
                (r[f].indexLabel || h.indexLabel || r[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                  chartType: "bar",
                  dataPoint: r[f],
                  dataSeries: h,
            ...
            for (k = 0; k < u.length; k++)
              if (b = u[k].x.getTime ? u[k].x.getTime() :
                ...
                var s = n - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                  C = s + h << 0,
                  D;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (D = f[b] ? f[b] : q, f[b] = l = a.axisY.convertValueToPixel(t[b]));
                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), l = p[b] ?
                  p[b] : q, p[b] = D = a.axisY.convertValueToPixel(B[b]);
                else if (l = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                  var z = f[b] ? f[b] : 0;
                  D = q + z;
                  l += z;
                  f[b] = z + (l - D)
                } else z = p[b] ? p[b] : 0, D = l - z, l = q - z, p[b] = z + (l - D);
                b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
                ...
                b = P(b);
                w && ca(this._eventManager.ghostCtx, D, s, l, C, b, 0, null, !1, !1, !1,
                  !1);
                (u[k].indexLabel || m.indexLabel || u[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                ...
                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = A + (B[b] ? B[b] : 0), l = p[b] ? p[b] :
                  q, p[b] = A = a.axisY.convertValueToPixel(B[b]);
                else if (l = a.axisY.convertValueToPixel(A), 0 <= u[k].y) {
                  var z = f[b] ? f[b] : 0;
                  A = q + z;
                  l += z;
                  a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x2 - l) && (l = e.x2);
                  f[b] = z + (l - A)
                } else z = p[b] ? p[b] : 0, A = l - z, l = q - z, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - A) && (A = e.x1), p[b] = z + (l - A);
                b = u[k].color ? u[k].color : m._colorSet[k % m._colorSet.length];
                ...
                b = P(b);
                w && ca(this._eventManager.ghostCtx, A, C, l, D, b, 0, null, !1, !1, !1, !1);
                (u[k].indexLabel || m.indexLabel || u[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        D && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = A : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = A), f.lineTo(m, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, w && (p.lineTo(m, C), p.lineTo(D.x, C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(m, u), p.beginPath(), p.moveTo(m, u), D = {
          x: m,
          y: u
        })
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          d = !0;
          var g = 0,
            m, u, s, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
            C, D = null;
          if (0 < r.length) {
            ...
            for (var ja = !0; g < r.length; g++)
              if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s <
                ...
                if ("number" !== typeof r[g].y) h.connectNullData || (ja || d) || b(), ja = !0;
                  ...
                  d || ja ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || c === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = m, c = u, m = l.x, u = l.y, b(), f.moveTo(l.x, l.y), m = d, u = c, D = l, c = h.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(m, u), w && p.lineTo(m, u)) :
                    (f.beginPath(), f.moveTo(m, u), w && (p.beginPath(), p.moveTo(m, u)), D = {
                      x: m,
                      y: u
                    }), ja = d = !1) : (f.lineTo(m, u), w && p.lineTo(m, u), 0 == g % 250 && b());
                  l = {
                    x: m,
                    y: u
                  };
                  ...
                  0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(g, m, u, f), B.push(s), Y = P(Y), w && B.push({
                    x: m,
                    y: u,
                    ctx: p,
                    type: s.type,
      ...
      function d() {
        ...
        if (0 < c.length) {
          ...
          a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
            m = g : 0 > a.axisY.viewportMaximum ? m = f.y1 : 0 < a.axisY.viewportMinimum && (m = g);
          u = {
            x: c[0].x,
            y: c[0].y
          };
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < n.length) {
            var A = l._colorSet[q % l._colorSet.length],
              C = l.lineColor = l.options.lineColor ||
              A,
              D = C;
            b.fillStyle = A;
            b.strokeStyle = C;
            ...
            for (r = !1; q < n.length; q++)
              if (h = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !r)))
                if ("number" !== typeof n[q].y) 0 < q && !r && (l.connectNullData ? b.setLineDash && (0 < s.length && (l.options.nullDataLineDashType || !n[q - 1].lineDashType)) &&
                  (s[s.length - 1].newLineDashArray = y, z = l.nullDataLineDashType) : (d(), s = [])), r = !0;
                else {
                  ...
                  q < n.length - 1 && (D !== (n[q].lineColor || C) || z !== (n[q].lineDashType || l.lineDashType)) && (D = n[q].lineColor || C, s[s.length - 1].newStrokeStyle = D, b.setLineDash && (n[q].lineDashType ? (z = n[q].lineDashType, s[s.length -
                    1].newLineDashArray = N(z, l.lineThickness)) : (z = l.lineDashType, s[s.length - 1].newLineDashArray = E)));
                  if (0 !== n[q].markerSize && (0 < n[q].markerSize || 0 < l.markerSize)) {
                  ...
                  }(n[q].indexLabel || l.indexLabel || n[q].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
    ...
    m.prototype.renderStepArea = function (a) {
      ...
      function b() {
        D && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = A : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = A), f.lineTo(m, C), f.lineTo(D.x, C), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, w && (p.lineTo(m, C), p.lineTo(D.x,
          C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(m, u), p.beginPath(), p.moveTo(m, u), D = {
          x: m,
          y: u
        })
      }
          ...
          if (0 < r.length) {
            ...
            for (; g < r.length; g++)
              if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !c))) {
                var Y = u;
                "number" !== typeof r[g].y ? (h.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(r[g].y), d || c ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || Q === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = m, c = u, m = l.x, u = l.y, b(),
                  f.moveTo(l.x, l.y), m = d, u = c, D = l, Q = h.nullDataLineDashType, f.setLineDash(aa)), f.lineTo(m, Y), f.lineTo(m, u), w && (p.lineTo(m, Y), p.lineTo(m, u))) : (f.beginPath(), f.moveTo(m, u), w && (p.beginPath(), p.moveTo(m, u)), D = {
                  x: m,
                  y: u
                }), c = d = !1) : (f.lineTo(m, Y), w && p.lineTo(m, Y), f.lineTo(m, u), w && p.lineTo(m, u), 0 == g % 250 && b()), l = {
                  x: m,
                  y: u
                }, g < r.length - 1 && (y !== (r[g].lineColor || v) || Q !== (r[g].lineDashType || h.lineDashType)) && (b(), y = r[g].lineColor || v, f.strokeStyle = y, f.setLineDash && (r[g].lineDashType ? (Q = r[g].lineDashType, f.setLineDash(N(Q,
                  ...
                  x1: m,
                  y1: u
                }, 0 !== r[g].markerSize && (0 < r[g].markerSize || 0 < h.markerSize) && (Y = h.getMarkerProperties(g, m, u, f), B.push(Y), s = P(s), w && B.push({
                  x: m,
                  y: u,
                  ctx: p,
                  type: Y.type,
    ...
    m.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null,
          ...
          n = [],
          q = 0,
          h, r, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
        ...
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          var D = a.dataSeriesIndexes[C],
            ...
            v = z.dataPoints;
          z.dataPointIndexes = [];
          for (q = 0; q < v.length; q++) D = v[q].x.getTime ? v[q].x.getTime() : v[q].x, z.dataPointIndexes[D] = q, e[D] || (l.push(D), e[D] = !0);
          l.sort(Pa)
        }
            ...
            for (var Y = !0, q = 0; q < l.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                if ("number" !== typeof fa.y) z.connectNullData || (Y || x) || d(), Y = !0;
                  ...
                  g[f] = m - r;
                  x || Y ? (!x && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || A === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = k.pop(), A = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(A), k.push(x), A = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(h,
                    r), w && s.lineTo(h, r)) : (b.beginPath(), b.moveTo(h, r), w && (s.beginPath(), s.moveTo(h, r))), Y = x = !1) : (b.lineTo(h, r), w && s.lineTo(h, r), 0 == q % 250 && (d(), b.moveTo(h, r), w && s.moveTo(h, r), k.push({
                    x: h,
                    y: m - ma
                  })));
                  u = {
                  ...
                  q < v.length - 1 && (Q !== (v[q].lineColor || y) || A !== (v[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(h, r), k.push({
                    x: h,
                    y: m - ma
                  }), Q = v[q].lineColor || y, b.strokeStyle = Q, b.setLineDash && (v[q].lineDashType ? (A = v[q].lineDashType, b.setLineDash(N(A, z.lineThickness))) : (A = z.lineDashType, b.setLineDash(E))));
                  ...
                  0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], h, r, b), p.push(ma), f = P(F), w && p.push({
                    x: h,
                    y: r,
                    ctx: s,
                    type: ma.type,
    ...
    m.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null,
          ...
          n = [],
          q = 0,
          h, r, m, s, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
        ...
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          var v = a.dataSeriesIndexes[C],
            ...
            y = z.dataPoints;
          z.dataPointIndexes = [];
          for (q = 0; q < y.length; q++) v = y[q].x.getTime ? y[q].x.getTime() : y[q].x, z.dataPointIndexes[v] = q, e[v] || (l.push(v), e[v] = !0);
          l.sort(Pa)
        }
        for (C = 0; C < a.dataSeriesIndexes.length; C++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                if ("number" !== typeof fa.y) z.connectNullData ||
                  ...
                  s || Y ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType &&
                    z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(u), k.push(s), u = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(h, r), w && A.lineTo(h, r)) : (b.beginPath(), b.moveTo(h, r), w && (A.beginPath(), A.moveTo(h, r))), Y = s = !1) : (b.lineTo(h, r), w && A.lineTo(h, r), 0 == q % 250 && (d(), b.moveTo(h, r), w && A.moveTo(h, r), k.push({
                    x: h,
                    y: x - ba
                  })));
                  m = {
    ...
    m.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = -Infinity, g = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
          for (var l = a.dataSeriesIndexes[k], n = this.data[l], q = n.dataPoints,
        ...
        for (var r = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), k = 0; k < a.dataSeriesIndexes.length; k++)
          if (l = a.dataSeriesIndexes[k], n = this.data[l], q = n.dataPoints, 0 < q.length)
            for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
              if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                ...
                var h = q[e].z,
                  s = 2 * Math.max(Math.sqrt((t === g ? m / 2 : r + (m - r) / (t - g) * (h - g)) / Math.PI) << 0, 1),
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length) {
            ...
            for (var n = 0, q = 0, e = 0; e < l.length; e++)
              if (f = l[e].getTime ? f = l[e].x.getTime() : f = l[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                f = a.axisX.convertValueToPixel(f);
                ...
                c.globalAlpha = 1;
                Math.sqrt((n - f) * (n - f) + (q - p) * (q - p)) < Math.min(h.size, 5) && l.length > Math.min(this.plotArea.width,
                  this.plotArea.height) || (n = k.dataPointIds[e], this._eventManager.objectMap[n] = {
                    ...
                    x1: f,
                    y1: p
                  }, n = P(n), w && V.drawMarker(h.x, h.y, this._eventManager.ghostCtx, h.type, h.size, n, n, h.borderThickness), (l[e].indexLabel || k.indexLabel || l[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                    chartType: "scatter",
                    dataPoint: l[e],
                    dataSeries: k,
                    point: {
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null,
          ...
          p = this.plotArea,
          t = 0,
          g, k, l, n, q, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
          ...
          if (0 < x.length)
            for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
              if (x[t].getTime ? h = x[t].x.getTime() : h = x[t].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] &&
                ...
                "candlestick" === u.type ? (c.moveTo(g - y, l), c.lineTo(g - y, Math.min(k, q)), c.stroke(), c.moveTo(g - y, Math.max(k, q)), c.lineTo(g - y, n), c.stroke(), ca(c, C, Math.min(k, q), D, Math.max(k, q), x[t].y[0] <= x[t].y[3] ? u.risingColor : f, z, e, A, A, !1, !1, u.fillOpacity), w && (e = P(E), b.strokeStyle = e, b.moveTo(g - y, l), b.lineTo(g - y, Math.min(k,
                  q)), b.stroke(), b.moveTo(g - y, Math.max(k, q)), b.lineTo(g - y, n), b.stroke(), ca(b, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(g - y, l), c.lineTo(g - y, n), c.stroke(), c.beginPath(), c.moveTo(g, k), c.lineTo(C, k), c.stroke(), c.beginPath(), c.moveTo(g, q), c.lineTo(D, q), c.stroke(), w && (e = P(E), b.strokeStyle = e, b.moveTo(g - y, l), b.lineTo(g - y, n), b.stroke(), b.beginPath(), b.moveTo(g, k), b.lineTo(C, k), b.stroke(), b.beginPath(), b.moveTo(g, q), b.lineTo(D, q), b.stroke()));
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null,
          f = this.plotArea,
          p = 0,
          t, g, k, l, n, q, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
          ...
          if (0 < A.length)
            for (var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0; p < A.length; p++)
              if (A[p].getTime ? h = A[p].x.getTime() : h = A[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(A[p].y) && A[p].y.length && "number" === typeof A[p].y[0] && "number" === typeof A[p].y[1] && "number" === typeof A[p].y[2] && "number" === typeof A[p].y[3] && "number" === typeof A[p].y[4] && 5 === A[p].y.length) {
                ...
                c.save();
                0 < ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = ba, c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(t - G, k), c.lineTo(t - G, g), c.stroke(), c.moveTo(t - G, n), c.lineTo(t - G, l), c.stroke());
                c.restore();
                b.lineWidth = Math.max(y, 4);
                c.beginPath();
                ca(c, D, Math.min(q, k), z, Math.max(k, q), xa, 0, e, m ? C : !1, m ? !1 : C, !1, !1, sa);
                c.beginPath();
                ca(c, D, Math.min(l, q), z, Math.max(q, l), R, 0, e, m ? !1 : C, m ? C : !1, !1, !1, sa);
                c.beginPath();
                c.lineWidth = y;
                c.strokeStyle = e;
                c.rect(D - E, Math.min(k, l) - E, z - D + 2 * E, Math.max(k, l) - Math.min(k, l) + 2 * E);
                c.stroke();
                c.save();
          ...
          if (0 < h.length)
            for (var r =
              ...
              if (h[f].getTime ? g = h[f].x.getTime() : g = h[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
                ...
                var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + l) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                    l) * k << 0,
                ...
                b = P(u);
                w && ca(this._eventManager.ghostCtx, m, p, v, t, b, 0, null, !1, !1, !1, !1);
      ...
      function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
          var e = null,
            ...
            p = this.plotArea,
            t = 0,
            g, k, l, n, q, h, r, m = a.axisX.dataInfo.minDiff;
          ...
          for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
            ...
            u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? p.height : p.width) * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) / (z ? v : 1)) << 0;
              ...
              for (var F = C._colorSet, t = 0; t < D.length; t++) {
                ...
                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                  ...
                  b ? (q = a.axisX.reversed ? k + (z ?
                    v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : k - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, h = a.axisX.reversed ? q - u << 0 : q + u << 0) : (l = a.axisX.reversed ? g + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : g - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, n = a.axisX.reversed ? l - u << 0 : l + u << 0);
                  !b && q > h && (ja = q, q = h, h = ja);
                  b && l > n && (ja = l, l = n, n = ja);
                  ja = C.dataPointIds[t];
                  ...
                  y(c, Math.min(l,
                    n), Math.min(q, h), Math.max(n, l), Math.max(h, q), e, Q, aa, b);
                  ...
                  if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({
                    ...
                    this._indexLabels.push({
                      ...
                      indexKeyword: 1,
                      point: {
                        x: b ? D[t].y[1] >= D[t].y[0] ? n : l : l + (n - l) / 2,
    ...
    m.prototype.renderRangeBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        l = this.options.dataPointWidth ? this.dataPointWidth : 0.9 *
          (e.height * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
        this.dataPointMaxWidth && f > p && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p));
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                ...
                g = a.axisX.reversed ? g + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount + n) * l << 0 : g - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + n) * l << 0;
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < n.length) {
            ...
            for (var Q = !0; h < n.length; h++)
              if (u = n[h].x.getTime ? n[h].x.getTime() : n[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !Q)))
                if (null !== n[h].y && n[h].y.length && "number" === typeof n[h].y[0] && "number" === typeof n[h].y[1]) {
                  ...
                  q || Q ? (l.connectNullData && !q ? (b.setLineDash && (l.options.nullDataLineDashType || z === l.lineDashType &&
                    l.lineDashType !== l.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = E, z = l.nullDataLineDashType, b.setLineDash(y)), b.lineTo(r, m), w && e.lineTo(r, m), g.push({
                    x: r,
                    y1: m,
                    y2: s
                    ...
                    y1: m,
                    y2: s
                  }), w && (e.beginPath(), e.moveTo(r, m))), Q = q = !1) : (b.lineTo(r, m), g.push({
                    x: r,
                    y1: m,
                    y2: s
                  }), w && e.lineTo(r, m), 0 == h % 250 && d());
                  u = l.dataPointIds[h];
                  this._eventManager.objectMap[u] = {
                    id: u,
                    objectType: "dataPoint",
                  ...
                  h < n.length -
                    1 && (D !== (n[h].lineColor || C) || z !== (n[h].lineDashType || l.lineDashType)) && (d(), D = n[h].lineColor || C, g[g.length - 1].newStrokeStyle = D, b.strokeStyle = D, b.setLineDash && (n[h].lineDashType ? (z = n[h].lineDashType, g[g.length - 1].newLineDashArray = N(z, l.lineThickness), b.setLineDash(g[g.length - 1].newLineDashArray)) : (z = l.lineDashType, g[g.length - 1].newLineDashArray = E, b.setLineDash(E))));
                  if (0 !== n[h].markerSize && (0 < n[h].markerSize || 0 < l.markerSize)) {
                  ...
                  if (n[h].indexLabel || l.indexLabel || n[h].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({
                      chartType: "rangeArea",
                      dataPoint: n[h],
                      dataSeries: l,
                      indexKeyword: 0,
        ...
        if (0 < d.length) {
          ...
          if (0 < k.lineThickness) {
            ...
            for (var h = f = 0; f < d.length - 3; f += 3, h++) {
              if (m[h].newStrokeStyle || m[h].newLineDashArray) b.stroke(), b.beginPath(),
                b.moveTo(d[f].x, d[f].y), m[h].newStrokeStyle && (b.strokeStyle = m[h].newStrokeStyle), m[h].newLineDashArray && b.setLineDash(m[h].newLineDashArray);
              b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
            }
            d = v(m, 2);
            b.moveTo(d[0].x, d[0].y);
            for (h = f = 0; f < d.length - 3; f += 3, h++) {
              if (m[h].newStrokeStyle || m[h].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), m[h].newStrokeStyle && (b.strokeStyle = m[h].newStrokeStyle), m[h].newLineDashArray && b.setLineDash(m[h].newLineDashArray);
              b.bezierCurveTo(d[f +
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < l.length) {
            ...
            for (h = !1; n < l.length; n++)
              if (q = l[n].x.getTime ? l[n].x.getTime() : l[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                  !h)))
                if (null !== l[n].y && l[n].y.length && "number" === typeof l[n].y[0] && "number" === typeof l[n].y[1]) {
                  ...
                  n < l.length - 1 && (A !== (l[n].lineColor || x) || C !== (l[n].lineDashType || k.lineDashType)) && (A = l[n].lineColor || x, m[m.length -
                    1].newStrokeStyle = A, b.setLineDash && (l[n].lineDashType ? (C = l[n].lineDashType, m[m.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, m[m.length - 1].newLineDashArray = D)));
                  ...
                  if (l[n].indexLabel || k.indexLabel || l[n].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({
                  ...
                  (0 < m.length && (k.options.nullDataLineDashType || !l[n - 1].lineDashType)) && (m[m.length - 1].newLineDashArray = z, C = k.nullDataLineDashType) : (d(D, x), m = [], s = [])), h = !0;
            d(D, x);
            V.drawMarkers(f)
          }
        }
    ...
    m.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = this._eventManager.ghostCtx,
          ...
          f = this.plotArea,
          p = 0,
          t, g, k, l, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < v.length)
            for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, D = null, z = null, p = 0; p < v.length; p++)
              if (v[p].getTime ?
                l = v[p].x.getTime() : l = v[p].x, "number" !== typeof v[p].y) {
    ...
    var W = function (a, d, c, b, e, f, p, g, m) {
      if (!(0 > c)) {
        ...
        a.save();
        a.globalAlpha = g;
        "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, p, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, p, !1), 0 <= m && a.arc(d.x, d.y, m * c, p, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
          2, a.fill());
        a.globalAlpha = 1;
        a.restore()
      }
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (k && l) {
          ...
          p = f = 0;
          n = !1;
          for (e = 0; e < l.length; e++) g = h[(c + e) % l.length], 1 < a && (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !n ? (g.hemisphere = "right", f++) : (g.hemisphere = "left", n = !0));
          n = !1;
          for (e = 0; e < l.length; e++) g = h[(d + e) % l.length], 1 < b && (g.midAngle > 3 * Math.PI / 2 - u && g.midAngle < 3 * Math.PI / 2 + u) && (p <= b / 2 && !n ? (g.hemisphere = "left", p++) : (g.hemisphere = "right", n = !0))
        }
      }
      ...
      function c(a) {
        ...
        for (b = 0; b < l.length; b++) {
          ...
          if (d > c) {
            var e = 0.07 * z * Math.cos(h[b].midAngle),
              ...
              p = !1;
            if (l[b].exploded) {
              if (1E-9 < Math.abs(h[b].center.x - (A.x + e)) || 1E-9 < Math.abs(h[b].center.y - (A.y + f))) h[b].center.x = A.x + e * a, h[b].center.y = A.y + f * a, p = !0
            } else if (0 < Math.abs(h[b].center.x - A.x) || 0 < Math.abs(h[b].center.y - A.y)) h[b].center.x = A.x + e * (1 - a), h[b].center.y = A.y + f * (1 - a),
              p = !0;
            p && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, m.toolTip.highlightObjects([e]));
            W(m.plotArea.ctx, h[b].center, h[b].radius, l[b].color ? l[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, h[b].percentInnerRadius)
          }
        }
        a = m.plotArea.ctx;
        a.save();
        ...
        a.lineJoin = "round";
        for (b = b = 0; b < l.length; b++) c = h[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !==
      ...
      function p() {
        ...
        for (var c = a = 0, d = 0, p = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var t, u, a = 0; a < l.length; a++) {
              ...
              if (null !== s) {
                ...
                var C = 0,
                  C = b(t, u) - r;
                if (0 > C) {
                  for (var D = u = 0, F = 0; F < l.length; F++) F !== a && h[F].hemisphere === g.hemisphere && (h[F].indexLabelTextBlock.y < g.indexLabelTextBlock.y ? u++ : D++);
                  u = C / (u + D || 1) * D;
                  var D = -1 * (C - u),
                    J = F = 0;
            ...
            for (a = 0; a < l.length; a++) g = h[a], w = "pie" === k.type ? 0.7 * z : 0.8 * z, s = A.x + w * Math.cos(g.midAngle), u = A.y + w * Math.sin(g.midAngle), g.indexLabelTextBlock.x = s, g.indexLabelTextBlock.y = u;
          for (a = 0; a < l.length; a++)
          ...
          var H = function (a,
            b, c) {
            for (var d = [], e = 0; d.push(h[b]), b !== c; b = (b + 1 + l.length) % l.length);
            d.sort(function (a, b) {
              return a.y - b.y
            });
              ...
              if (f = !1, t = h[k], t.indexLabelText) {
                ...
                if (null !== p) {
                  ...
                  if (q = 0 > C) {
                    ...
                    q = t.indexLabelTextBlock.x + t.indexLabelTextBlock.width < g.indexLabelTextBlock.x - n || q > u + n || m > B + n || r < s - n ? !1 : !0
                  }
                  q ? (0 > a && (a = k), p !== a && (c = p, d += -C), 0 === k % Math.max(l.length / 10, 3) && (f = !0)) : f = !0;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var k =
          ...
          C = 0;
        a = !1;
        for (var D = 0; D < l.length; D++) C += Math.abs(l[D].y), !a && ("undefined" !== typeof l[D].indexLabel && null !== l[D].indexLabel && 0 < l[D].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof l[D].label && null !== l[D].label && 0 < l[D].label.toString().length) && (a = !0);
        if (0 !== C) {
          ...
          this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
            ...
            b.fillStyle = m.backgroundColor;
            b.fillRect(q.x1, q.y1, q.width, q.height);
            for (var b = h[0].startAngle + 2 * Math.PI * a, c = 0; c < l.length; c++) {
              var d = 0 === c ? h[c].startAngle : e,
                e = d + (h[c].endAngle - h[c].startAngle),
                f = !1;
              e > b && (e = b, f = !0);
              var p = l[c].color ? l[c].color : k._colorSet[c % k._colorSet.length];
              e > d && W(m.plotArea.ctx, h[c].center, h[c].radius, p, k.type, d, e, k.fillOpacity, h[c].percentInnerRadius);
              if (f) break
            }
            g();
            m.dispatchEvent("dataAnimationIterationEnd", {
    ...
    m.prototype.renderFunnel =
      function (a) {
        ...
        function c() {
          ...
          if (0 ===
            h) return -1;
          for (var p = d[0] = 0, g = 0, l, n, b = b - a, p = !1, k = 0; k < x.length; k++) a = Math.abs(x[k].y) * f / h, p ? l = 0 == Number(c.toFixed(3)) ? 0 : a / c : (n = $ * $ * b * b - 4 * Math.abs($) * a, 0 > n ? (n = c, p = (b + n) * (e - g) / 2, a -= p, l = e - g, g += e - g, l += 0 == n ? 0 : a / n, g += a / n, p = !0) : (l = (Math.abs($) * b - Math.sqrt(n)) / 2, n = b - 2 * l / Math.abs($), g += l, g > e && (g -= l, n = c, p = (b + n) * (e - g) / 2, a -= p, l = e - g, g += e - g, l += a / n, g += a / n, p = !0), b = n)), d.push(l);
          return d
        }

        function b() {
          if (u && x) {
            for (var a, b, c, d, e, f, k, p, g, l, n, q, t, m, r, B = [], v = [], A = {
                percent: null,
                total: null
            ...
            for (var z = 0, D = x.length - 1; z < x.length || 0 <= D; z++, D--) {
              ...
              l = "number" === typeof b.indexLabelLineThickness ? b.indexLabelLineThickness : "number" === typeof u.indexLabelLineThickness ? u.indexLabelLineThickness : 2;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
          ...
          if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
            ...
            if (-1 !== H) {
              ...
              v(R);
              J && u.visible && ("inside" === u.indexLabelPlacement || y.animationEnabled || l(R), y.animationEnabled || r());
              if (!J)
    ...
    m.prototype.exportChart = function (a) {
      ...
      if (b && d && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob) {
          for (var p = b.replace(/^data:[a-z\/]*;base64,/, ""), p = atob(p), g = new ArrayBuffer(p.length), g = new Uint8Array(g), m = 0; m < p.length; m++) g[m] = p.charCodeAt(m);
          d = new Blob([g.buffer], {
            type: "image/" + d
          });
          try {
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        if ("x" === a)
          if (c.axisX && "dateTime" ===
            ...
            if (!c.axisX.logarithmic) return Aa(h, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
          } else return ea(h, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo);
    ...
    H.prototype.getDataPointAtX = function (a, d) {
      ...
      for (;;) {
        ...
        } else if (0 > l - e && l + e >= this.dataPoints.length) break; - 1 === p ? (e++, p = 1) : p = -1
      }
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
        ...
        if (this.logarithmic && !this.equidistantInterval)
          for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, h = q; b < this.logLabelValues.length; b++)
            if (c =
              ...
              }) : "axisX" === this.type && this.labels[l] ? this.labels[l] : ea(l, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: f,
                maxHeight: p,
        ...
        for (this.intervalStartPosition =
          ...
          a || (a = this.labelFormatter ? this.labelFormatter({
            ...
            this.labels[l] : Aa(l, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
              x: 0,
              y: 0,
              maxWidth: f,
              backgroundColor: this.labelBackgroundColor,
          ...
          if (f = 0.9 * g >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            ...
            for (c = 0; c < this._labels.length; c++)
              if (!this._labels[c].breaksLabelType) {
                ...
                for (var v, h = a.text.split(" "), b = 0; b < h.length; b++) l = h[b], this.ctx.font = a.fontStyle + " " +
                  a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, l = this.ctx.measureText(l), l.width > q && (v = c, q = l.width)
              } c = 0;
            for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
              if (!this._labels[c].breaksLabelType) {
                ...
                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                  if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), l = (k - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
                    ...
                    if (s(this.options.labelWrap))
                      ...
                      if (b = r.width + d.width >> 0, h = this.labelFontSize, q < f) b - 2 * f > n && (n = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ?
                        ...
                        h : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = l, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = l) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = h, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelAngle = this.labelAngle));
                  ...
                  this.options.labelMaxWidth : l) : (s(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = p)
    ...
    E.setLayout = function (a, d, c, b, e, f) {
      var p, g, m, k, l = a[0] ? a[0].chart : d[0].chart,
      ...
      if ("normal" === e) {
        for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 >
          ...
          var G = 0,
            ...
            $ = 0;
          if (c && 0 < c.length)
            for (y = [], h = O = 0; h < c.length; h++) y.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)), O += y[h], L += c[h] && !l.isNavigator ? c[h].margin : 0;
          ...
          if (c && 0 < c.length)
            for (h = 0; h < c.length; h++) L = l.isNavigator ? 0 : 10, c[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : n, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height /
              2 : n, k = Math.round(f.y2 - T - e - L), c[h].lineCoordinates = {
                x1: p - U,
                y1: g,
                x2: m - U,
                y2: k,
                height: Math.abs(k - g)
              }, "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.x1 = c[h].lineCoordinates.x1 - (y[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0)) + ("outside" === c[h].tickPlacement ? c[h].tickLength : 0), c[h].lineCoordinates.x2 = c[h].lineCoordinates.x1 + c[h].lineThickness / 2), c[h].bounds = {
                x1: p - (y[h] + U),
                y1: g,
                x2: m,
                y2: k,
          ...
          if (b && 0 < b.length)
            for (h = 0; h < b.length; h++) b[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(p), L = b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2 : 0, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), L = 0 < a.length ? 0 : b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (T + e + L)), b[h].lineCoordinates = {
              x1: p + X,
              y1: g,
              x2: p + X,
              y2: k,
              height: Math.abs(k - g)
            }, "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.x1 = b[h].lineCoordinates.x1 + (D[h] - (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)) - ("outside" === b[h].tickPlacement ? b[h].tickLength : 0) - 2, b[h].lineCoordinates.x2 = b[h].lineCoordinates.x1 + b[h].lineThickness / 2), b[h].bounds = {
              x1: p,
              y1: g,
              x2: m + (D[h] + X),
              y2: k,
              width: m - p,
              height: k - g
            }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.height ? b[h].titleMaxWidth :
        ...
        for (N = []; 4 > w;) {
          ...
          if (a && 0 < a.length)
            for (F = [], h = X = 0; h < a.length; h++) F.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateWidth() : 0)), X += F[h], e += a[h] && !l.isNavigator ? a[h].margin : 0;
          ...
          if (l.panEnabled)
            for (h = 0; h < c.length; h++) n[h] = s(l.sessionVariables.axisY.height) ?
              l.sessionVariables.axisY.height = n[h] : l.sessionVariables.axisY.height;
          else
            for (h = 0; h < c.length; h++) l.sessionVariables.axisY.height = n[h];
          if (c && 0 < c.length)
            for (h = c.length - 1; 0 <= h; h--) g = Math.round(f.y2), k = Math.round(f.y2 > c[h].chart.height ? c[h].chart.height : f.y2), c[h].lineCoordinates.y1 = g - (n[h] + c[h].margin + V), c[h].lineCoordinates.y2 = g - (n[h] + c[h].margin + V), "inside" === c[h].labelPlacement && 0 < h && (c[h].lineCoordinates.y1 = c[h].lineCoordinates.y1 + n[h] - (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0) - ("inside" ===
              c[h].tickPlacement ? c[h].tickLength : 0), c[h].lineCoordinates.y2 = c[h].lineCoordinates.y1 + c[h].lineThickness / 2), c[h].bounds = {
              x1: p,
              ...
              width: m - p,
              height: n[h]
            }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width), V += n[h] + c[h].margin;
          if (b && 0 < b.length)
            for (h = b.length - 1; 0 <= h; h--) b[h] && (g = Math.round(f.y1), k = Math.round(f.y1 + (z[h] + b[h].margin + G)), b[h].lineCoordinates.y1 =
              k, b[h].lineCoordinates.y2 = k, "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.y1 = k - z[h] + (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)), b[h].bounds = {
                x1: p,
                y1: g + (b[h].margin + G),
                x2: m,
                y2: k,
                width: m - p,
                height: S
              }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width), G += z[h] + b[h].margin);
          if (a && 0 < a.length)
            for (h = 0; h < a.length; h++) {
              ...
              k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > l.height - Math.max(L, 10) ? l.height - Math.max(L, 10) : f.y2 - U) : f.y2 > l.height - Math.max(L, 10) ? l.height - Math.max(L, 10) : f.y2;
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, x) : 0 === c[L].labelAngle ? Math.max(m, x / 2) : m, p =
                  0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - X : p);
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (m = b[L].lineCoordinates.x1, p = m - X);
              a[h].lineCoordinates = {
                x1: m - P,
                y1: g,
                x2: m - P,
          ...
          if (d && 0 < d.length)
            for (h = 0; h < d.length; h++) {
              ...
              k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > l.height - Math.max(L, 10) ? l.height - Math.max(L, 10) : f.y2 - U) : f.y2 > l.height - Math.max(L, 10) ? l.height - Math.max(L, 10) : f.y2;
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, x) : 0 === c[L].labelAngle ? Math.max(m, x / 2) : m, p = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - T : p);
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++) b[L] &&
                  b[L].labelAutoFit && (m = b[L].lineCoordinates.x2, p = m - T);
              d[h].lineCoordinates = {
                x1: m + R,
                y1: g,
                x2: m + R,
      ...
      if ("undefined" === typeof this.options.interval) {
        if ("bottom" === this._position || "top" === this._position)
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, m = this.viewportMaximum, s = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length -
                1; 0 <= k; k--) {
              n = this._labels[k];
              if (n.position < this.viewportMinimum) break;
              n.position > this.viewportMaximum || !(k === this._labels.length - 1 || g < Math.log(m / n.position) * s / e) || (c.push(n), m = n.position, g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
            }
            this._labels = c
          } else {
          ...
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (var c = [], l, m = this.viewportMaximum, s = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
              n = this._labels[k];
              if (n.position < this.viewportMinimum) break;
              n.position > this.viewportMaximum || !(k === this._labels.length - 1 || l < Math.log(m / n.position) *
                s) || (c.push(n), m = n.position, l = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
            }
            this._labels = c
          } else {
            for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (l = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += l);
    ...
    E.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines &&
        ...
        for (var d = this, c, b = 0, e = 0, f = !1, g = !1, m = [], w = [], g = !1, b = 0; b < this.stripLines.length; b++) {
          var k = this.stripLines[b];
          k._thicknessType === a && ("pixel" === a && (k.value < this.viewportMinimum || k.value > this.viewportMaximum || s(k.value) || isNaN(this.range)) || "value" === a && (k.startValue <= this.viewportMinimum && k.endValue <= this.viewportMinimum || k.startValue >= this.viewportMaximum && k.endValue >= this.viewportMaximum || s(k.startValue) || s(k.endValue) || isNaN(this.range)) || m.push(k))
        }
        for (b = 0; b < this._stripLineLabels.length; b++)
          if (k =
            ...
            if ("outside" === c.stripLine.labelPlacement)
              if (k && (this.ctx.strokeStyle = k.color, "pixel" === k._thicknessType && (this.ctx.lineWidth = k.thickness)), "bottom" === this._position) {
                var l = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0;
                this.ctx.beginPath();
              ...
              } else "top" === this._position ? (l = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(l, a.y << 0), this.ctx.lineTo(l, a.y - this.tickLength << 0), this.ctx.stroke(), 0 === this.labelAngle ? (a.x -= c.textBlock.width /
          ...
          this.ctx.clip();
          for (b = 0; b < m.length; b++) k =
            m[b], k.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
              this.ctx.save();
              this.ctx.beginPath();
              this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
              this.ctx.clip();
              for (e = 0; e < m.length; e++) k = m[e], k.showOnTop && k.render();
              this.ctx.restore()
            }, k)) : k.render();
      ...
      if ("bottom" === this._position || "top" === this._position) {
          ...
          if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
            if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
              ...
              for (var m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) d.moveTo(e,
                g), d.lineTo(this.scaleBreaks._appliedBreaks[m].startPixel + c, g), e = this.scaleBreaks._appliedBreaks[m].endPixel + b;
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
            ...
            for (m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) d.moveTo(g, e), d.lineTo(g, this.scaleBreaks._appliedBreaks[m].startPixel + b), e = this.scaleBreaks._appliedBreaks[m].endPixel + c;
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = E.getNiceExponent(Math.log(g) / d / (a - 1), !0), c = E.getNiceNumber(m / (a - 1), !0));
    ...
    T.prototype.render = function (a) {
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
          if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, g = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, m = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
              x1: b - n / 2,
              y1: e,
              x2: g + n / 2,
              y2: m
            }, this.ctx.moveTo(b,
              e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, m), this.ctx.lineTo(g, m), this.ctx.lineTo(g, e);
          else if ("wavy" === this.type) {
          s = b;
          k = e;
          f = 0.5;
          l = (m - k) / a / 3;
          for (var q = 0; q < l; q++) this.ctx.bezierCurveTo(s + f * a, k + a, s + f * a, k + 2 * a, s, k + 3 * a), k += 3 * a, f *= -1;
          this.ctx.bezierCurveTo(s + f * a, k + a, s + f * a, k + 2 * a, s, k + 3 * a);
          s = g;
          f *= -1;
          this.ctx.lineTo(s, k);
          for (q = 0; q < l; q++) this.ctx.bezierCurveTo(s + f * a, k - a, s + f * a, k - 2 * a, s, k - 3 * a), k -= 3 * a, f *= -1
        } else {
          if ("zigzag" ===
            this.type) {
            f = -1;
            ...
            s = b + a;
            l = (m - k) / a / 2;
            for (q = 0; q < l; q++) this.ctx.lineTo(s, k), s += 2 * f * a, k += 2 * a, f *= -1;
            this.ctx.lineTo(s, k);
            s += g - b;
            for (q = 0; q < l + 1; q++) this.ctx.lineTo(s, k), s += 2 * f * a, k -= 2 * a, f *= -1;
            this.ctx.lineTo(s + f * a, k + a)
          }
        } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position)
          if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0, m = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, g = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
              g = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
              x1: b,
              y1: e - n / 2,
              x2: g,
              y2: m + n / 2
            }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, e), this.ctx.lineTo(g, m), this.ctx.lineTo(b, m);
          else if ("wavy" === this.type) {
          s = b;
          k = e;
          f = 0.5;
          l = (g - s) / a / 3;
          for (q = 0; q < l; q++) this.ctx.bezierCurveTo(s + a, k + f * a, s + 2 * a, k + f * a, s + 3 * a, k), s += 3 * a, f *= -1;
          ...
          s = b + a;
          l = (g - s) / a / 2;
          for (q = 0; q < l; q++) this.ctx.lineTo(s, k), k += 2 * f * a, s += 2 * a, f *= -1;
          this.ctx.lineTo(s, k);
          k += m - e;
          for (q = 0; q < l + 1; q++) this.ctx.lineTo(s, k), k += 2 * f * a, s -= 2 * a, f *= -1;
    ...
    M.prototype.render = function () {
      ...
      if (0 < d) {
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 ===
          this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, m = this.chart.plotArea.y2, this.bounds = {
            x1: e - d / 2,
            y1: g,
            x2: f + d / 2,
            y2: m
          };
        else if ("left" === this.parent._position || "right" === this.parent._position) g = m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = {
          x1: e,
          y1: g - d / 2,
          x2: f,
          y2: m + d / 2
    ...
    $.prototype.render = function (a, d, c) {
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y && v.dataSeries.visible && l.push(v));
          v = null;
          ...
          y = 0;
          if ("rangeBar" === l[0].dataSeries.type ||
            "error" === l[0].dataSeries.type)
            for (var v = Math.abs(a - this.parent.convertValueToPixel(l[y].dataPoint.y[0])), u = 0, r = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (var x = 0; x < l[r].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(l[r].dataPoint.y[x])), u < v && (v = u, y = r);
              else u = Math.abs(a - this.parent.convertValueToPixel(l[r].dataPoint.y)), u < v && (v = u, y = r);
          else if ("stackedBar" === l[0].dataSeries.type)
            for (var v = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y)), A = u =
                0, r = y = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(l[r].dataPoint.y[x])), u < v && (v = u, y = r);
              else A += l[r].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(A)), u < v && (v = u, y = r);
          else if ("stackedBar100" === l[0].dataSeries.type)
            for (var v = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y)), C = A = u = 0, r = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++) u =
                  Math.abs(a - this.parent.convertValueToPixel(l[r].dataPoint.y[x])), u < v && (v = u, y = r);
              else A += l[r].dataPoint.y, C = l[r].dataPoint.x.getTime ? l[r].dataPoint.x.getTime() : l[r].dataPoint.x, C = 100 * (A / l[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, y = r);
          else
            for (v = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y)), r = y = u = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(l[r].dataPoint.y[x])),
                  u < v && (v = u, y = r);
              else u = Math.abs(a - this.parent.convertValueToPixel(l[r].dataPoint.y)), u < v && (v = u, y = r);
          x = l[y];
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
              ...
              m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) <<
              ...
              v = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y));
              A = u = 0;
              for (r = y; 0 <= r; r--) A += l[r].dataPoint.y, u = Math.abs(a -
              ...
              v = Math.abs(a - this.parent.convertValueToPixel(l[0].dataPoint.y));
              C = A = u = 0;
              for (r = y; 0 <= r; r--) A += l[r].dataPoint.y, C = l[r].dataPoint.x.getTime ? l[r].dataPoint.x.getTime() : l[r].dataPoint.x, C = 100 * (A / l[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(a - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
              ...
              k.text = this.labelFormatter ? this.labelFormatter({
                ...
                c : C, this.valueFormatString, this.chart._cultureInfo) : this.label
            } else m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, this.value = x.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : x.dataPoint.y
            ...
            if (this.parent.labels)
              for (l = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += l)
          ...
          for (y = 0; y < this.parent.dataSeries.length; y++)(v = this.parent.dataSeries[y].getDataPointAtX(r,
            !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[y], null !== v.dataPoint.y && v.dataSeries.visible && l.push(v));
          if (0 === l.length) return;
          l.sort(function (a, b) {
            return a.distance - b.distance
          });
          y = 0;
          if ("rangeColumn" === l[0].dataSeries.type || "rangeArea" === l[0].dataSeries.type || "error" === l[0].dataSeries.type || "rangeSplineArea" === l[0].dataSeries.type || "candlestick" === l[0].dataSeries.type || "ohlc" === l[0].dataSeries.type || "boxAndWhisker" === l[0].dataSeries.type)
            for (v = Math.abs(d - this.parent.convertValueToPixel(l[0].dataPoint.y[0])),
              r = u = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(l[r].dataPoint.y[x])), u < v && (v = u, y = r);
              else u = Math.abs(d - this.parent.convertValueToPixel(l[r].dataPoint.y)), u < v && (v = u, y = r);
          else if ("stackedColumn" === l[0].dataSeries.type || "stackedArea" === l[0].dataSeries.type)
            for (v = Math.abs(d - this.parent.convertValueToPixel(l[0].dataPoint.y)), r = A = u = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x <
                  l[r].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(l[r].dataPoint.y[x])), u < v && (v = u, y = r);
              else A += l[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(A)), u < v && (v = u, y = r);
          else if ("stackedColumn100" === l[0].dataSeries.type || "stackedArea100" === l[0].dataSeries.type)
            for (v = Math.abs(d - this.parent.convertValueToPixel(l[0].dataPoint.y)), r = C = A = u = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(l[r].dataPoint.y[x])),
                  u < v && (v = u, y = r);
              else A += l[r].dataPoint.y, C = l[r].dataPoint.x.getTime ? l[r].dataPoint.x.getTime() : l[r].dataPoint.x, C = 100 * (A / l[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, y = r);
          else
            for (v = Math.abs(d - this.parent.convertValueToPixel(l[0].dataPoint.y)), r = u = 0; r < l.length; r++)
              if (l[r].dataPoint.y && l[r].dataPoint.y.length)
                for (x = 0; x < l[r].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(l[r].dataPoint.y[x])), u < v && (v = u, y = r);
              else u = Math.abs(d -
                this.parent.convertValueToPixel(l[r].dataPoint.y)), u < v && (v = u, y = r);
          x = l[y];
          b = 0;
          if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
            ...
            A = u = 0;
            for (r = y; 0 <= r; r--) A += l[r].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(A)), u < v && (v = u, b = r);
            ...
            v = Math.abs(d - this.parent.convertValueToPixel(l[0].dataPoint.y));
            A = u = 0;
            for (r = y; 0 <= r; r--) A += l[r].dataPoint.y, C = l[r].dataPoint.x.getTime ? l[r].dataPoint.x.getTime() : l[r].dataPoint.x, C = 100 * (A / l[r].dataSeries.plotUnit.dataPointYSums[C]), u = Math.abs(d - this.parent.convertValueToPixel(C)), u < v && (v = u, b = r);
            w =
            ...
            k.text = this.labelFormatter ? this.labelFormatter({
              ...
              crosshair: this.options,
              value: c ? c : C
            }) : s(this.options.label) ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo) : this.label;
            this.value = C
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, g = this.chart.plotArea.y2, this.bounds = {
          x1: b - n / 2,
          y1: f,
          x2: e + n / 2,
          y2: g
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          ...
          l = "";
          if (this.parent.labels)
            for (l = Math.ceil(this.parent.interval),
              r = 0; r < this.parent.viewportMaximum; r += l)
              if (this.parent.labels[r]) C = !0;
              else {
                C = !1;
                break
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
              ...
              for (var v = 0; v < this.chart.axisX.length; v++) {
                for (var g =
                    this.chart.axisX[v].convertPixelToValue({
                      y: d
                    }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && m.push(k));
                k = null
              }
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++) {
                ...
                k = null;
                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index &&
                  (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && m.push(k));
                k = null
              }
          } else {
            m = [];
            ...
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++)
                for (g = this.chart.axisX2[v].convertPixelToValue({
                  ...
                  k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && m.push(k))
          }
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (var d = null, c = null, b = null, e = 0, f = "", g = !0, m = 0; m < a.length; m++)
        ...
        for (var s = null, k = "", m = 0; m < a.length; m++) c = a[m].dataSeries, b = a[m].dataPoint, e = a[m].index, f = "", 0 === m && (g && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? k += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ?
